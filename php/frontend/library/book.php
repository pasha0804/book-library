...
<div class="book-div">
    ...
    ?>" method="post">
    <input type="submit" name="back" id="back-btn" class="btn btn-outline-danger" style="float: right;" value="⟲ Zurück">
    </form>
    ...
    <br>
    <h3><b style="color: beige">Zustand:</b> <?php if ($status == "S") {
            echo "Schlecht";
        }
        if ($status == "M") {
            echo "Mittel";
    ...
    <br>
    <h3><b style="color: beige">Verkauft:</b> <?php if ($sold == "0") {
            echo "Nein";
        } else {
            echo "Ja";
        } ?> </h3>
